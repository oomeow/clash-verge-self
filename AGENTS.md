...
This project is indexed by GitNexus as **clash-verge-self** (6410 symbols, 11418 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
