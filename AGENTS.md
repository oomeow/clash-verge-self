...
This project is indexed by GitNexus as **clash-verge-self** (6307 symbols, 11187 relationships, 295 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
